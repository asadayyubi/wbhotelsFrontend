...
import { getCityMenu, getHotelsByCustomerOrLocation } from "../redux/actions/hotels";
    ...
    <BrowserRouter>
      <ScrollToTop>
        ...
        <Routes>
            ...
            <Route exact path="/cancellationpage" element={<CancellationPage />} />
            ...
            <Route exact path="/airpay/responseairpay" element={<AirpayResponse />} />
