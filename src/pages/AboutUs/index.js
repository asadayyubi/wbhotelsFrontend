import about from '../../media/images/ABOUT US BANNER.png'
...
const AboutUs = () => {
    return (
        ...
        <div style={{width: "80%", margin: "50px auto", minHeight: "100vh"}}>
            ...
            /> 
            <p style={{fontWeight: "bold", fontSize: "2.5rem", textAlign: "center", marginTop: "2rem"}}>About Us</p>
            <p style={{marginTop: "1rem", fontSize: "1.7rem", font: "message-box"}}>
